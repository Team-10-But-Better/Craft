 ...
 * Global variable to store mouse DPI multiplier
 */
double keyDPIMultiplier = 1.0;
double mouseDPIMultiplier = 0.0001;
...
void on_key(GLFWwindow *window, int key, int scancode, int action, int mods)
{
    ...
    {
        /* Task 3 Issue 7: https://github.com/Team-10-But-Better/Craft/issues/7
        * The following three if statements check which button was pressed. Depending on which button, the mouse DPI multiplier
        * is either incremented, decremented, or set to the default value of .0001. Range: [.0001 (default), .001]
        * The following three statements also alter the key DPI multiplier [1.0 (default), 2.0]
        */
        ...
        if (key == CRAFT_KEY_SET_DEFAULT_DPI)
        {
            ...
            keyDPIMultiplier = 1.0;
            printf("Key DPI multiplier set to default: .1\n");
        }
